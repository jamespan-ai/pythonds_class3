...
sessions['campaign_retarget']=sessions['campaign'].str.contains('retarget')

## 8-4 查詢 符合 campaign 為 retarget 的記錄,只看 campaign 與 device　二欄位

print(sessions.loc[sessions['campaign_retarget'],['campaign','device']])
